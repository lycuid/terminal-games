...
Ball::Ball(Coordinates point, int u, int l)
  : point(point), upper_bound(u), lower_bound(l) {}
...
void Ball::step()
{
  ...
  switch (this->direction) {
    ...
    case SE: this->point.x++; this->point.y++; break;
    case SW: this->point.x--; this->point.y++; break;
    case NW: this->point.x--; this->point.y--; break;
    default: break;
  }
}

void Ball::render() {
  if (this->dead_trail != nullcrds)
